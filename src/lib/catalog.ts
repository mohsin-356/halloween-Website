...
const SEEDS: Seed[] = [
  ...
  ["Graveyard Bride & Groom Set", "costumes", "Couples", "gothic-elegance", 239, HALLOWEEN.structures.tombstones, 3, "adults"],
  ...
  ["Hollow Lane Pathway Markers", "decorations", "Outdoor", "graveyard", 74, HALLOWEEN.structures.tombstones, 2, "all"],
  ...
  ["Bone Orchard Skeleton 5ft", "props", "Skeletons", "graveyard", 199, HALLOWEEN.structures.tombstones, 4, "teens"],
